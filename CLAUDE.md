...
This project is indexed by GitNexus as **aitutor** (17985 symbols, 21388 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
