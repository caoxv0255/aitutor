...
import resetPasswordHandler, { sendResetCodeHandler } from './api/reset-password.js';
import guestLoginHandler from './api/guest-login.js';
import questionsHandler from './api/questions.js';
import reportsHandler from './api/reports.js';
import proxyHandler from './api/proxy.js';
import tasksHandler from './api/tasks.js';
import knowledgePointsHandler, { getWeakPointsHandler } from './api/knowledge-points.js';
import generatePaperHandler from './api/generate-paper.js';
import explainQuestionHandler from './api/explain-question.js';
import learningPathHandler from './api/learning-path.js';
import { getProvinces, getProvinceByCode, getProvinceStats } from './api/provinces.js';
import { getProvinceTrends, getProvinceCompare } from './api/province-trends.js';
import { getLearningDashboard } from './api/learning-dashboard.js';
import { seedProvinces } from './api/seed-provinces.js';
import { getUserProvince, setUserProvince, deleteUserProvince } from './api/user-province.js';
