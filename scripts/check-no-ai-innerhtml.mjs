...
const ALLOW = [
  ...
  { file: 'frontend/assets/js/pages/province-page.js', line: 456, reason: 'renderPapers：title/paperTypeLabel/paper.id 均经 escapeHTML（paper.id 已改 data-paper-id 委托，无内联 onclick）；year/exam_level 未转义，遗留，非 LLM 输出', date: '2026-09-24' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 511, reason: '知识点条形图：label 经 escapeHTML，value 数值', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 535, reason: '知识点表：name 经 escapeHTML，count 数值', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 565, reason: '题型条形图：label 经 escapeHTML，count 数值', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 682, reason: '分年份题型图：label/subject 均经 escapeHTML（subject 已 escape，内联 onclick 已改委托），count 数值，遗留，非 LLM 输出', date: '2026-09-24' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 717, reason: '题型表：label 经 escapeHTML，数值字段', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 745, reason: '难度条形图：label 枚举，count 数值', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 830, reason: '分年份难度图：label 枚举/escapeHTML，count 数值', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 839, reason: '难度表：levelNames 枚举 + 数值', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 858, reason: 'Top 知识点条形图：name 经 escapeHTML，frequency 数值', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 882, reason: 'Top 知识点表：name 经 escapeHTML，数值', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 916, reason: '趋势摘要：title/highlights/recommendations 均经 escapeHTML', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 918, reason: '摘要经 escapeHTML', date: '2026-09-23' },
  { file: 'frontend/assets/js/pages/province-page.js', line: 1042, reason: '年度趋势表：subjectName/label 经 SUBJECT_MAP 映射或原始枚举，数值字段，遗留，非 LLM 输出', date: '2026-09-23' },
];
